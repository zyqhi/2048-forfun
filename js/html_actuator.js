...
HTMLActuator.prototype.addTile = function (tile) {
  ...
  if (tile.value == 2) 
      ...
      inner.textContent = "天";//tile.value;
  else if (tile.value == 128)
      inner.textContent = "使";//tile.value;
  else if (tile.value == 256)
      inner.textContent = "节";//tile.value;
  else if (tile.value == 512)
      inner.textContent = "快";//tile.value;
  else if (tile.value == 1024)
      inner.textContent = "乐";//tile.value;
